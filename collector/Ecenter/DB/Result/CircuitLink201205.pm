package Ecenter::DB::Result::CircuitLink201205;
...
__PACKAGE__->table("circuit_link_201205");
...
__PACKAGE__->add_unique_constraint("cir_link_201205_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lkv5jYNU3FHz9W8bwXJAXA
