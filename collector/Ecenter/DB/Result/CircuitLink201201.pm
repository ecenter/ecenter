package Ecenter::DB::Result::CircuitLink201201;
...
__PACKAGE__->table("circuit_link_201201");
...
__PACKAGE__->add_unique_constraint("cir_link_201201_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/XlCQCN7OrHobjmZcCF4Nw
