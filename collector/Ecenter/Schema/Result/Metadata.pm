...
__PACKAGE__->add_columns(qw/metaid  src_ip dst_ip  eventtype_id subject parameters/); 
...
__PACKAGE__->add_unique_constraint(  md_ips_type => [ qw/src_ip dst_ip eventtype_id/ ]);
