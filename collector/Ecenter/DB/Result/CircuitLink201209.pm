package Ecenter::DB::Result::CircuitLink201209;
...
__PACKAGE__->table("circuit_link_201209");
...
__PACKAGE__->add_unique_constraint("cir_link_201209_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0Co+NyF5aq6tKXpQ00LuxQ
