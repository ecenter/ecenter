package Ecenter::DB::Result::CircuitLink201212;
...
__PACKAGE__->table("circuit_link_201212");
...
__PACKAGE__->add_unique_constraint("cir_link_201212_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sJN7izdFl+7FI55rhsP8Sw
