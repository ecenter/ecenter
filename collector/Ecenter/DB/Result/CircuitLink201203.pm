package Ecenter::DB::Result::CircuitLink201203;
...
__PACKAGE__->table("circuit_link_201203");
...
__PACKAGE__->add_unique_constraint("cir_link_201203_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CILT5RSV9I5ucMmd1KH/Aw
