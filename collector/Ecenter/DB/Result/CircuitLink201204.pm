package Ecenter::DB::Result::CircuitLink201204;
...
__PACKAGE__->table("circuit_link_201204");
...
__PACKAGE__->add_unique_constraint("cir_link_201204_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uCWhIS7kbWwT2trCO30bxw
