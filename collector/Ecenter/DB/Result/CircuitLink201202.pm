package Ecenter::DB::Result::CircuitLink201202;
...
__PACKAGE__->table("circuit_link_201202");
...
__PACKAGE__->add_unique_constraint("cir_link_201202_port", ["circuit_link_id", "l2_urn"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BiHFca5LoRTUjuQYs4yNtw
